  ...
  return (
    <div className="page">
      <Head>
        ...
        <script type='javascript' src='../js/index.js'/>
      </Head>
          ...
          <section className='ISAAC' >
            ...
            <div className='ISAAC_section'>
              ...
              <section className="slider-wrapper">
                <button className="slide-arrow" id="slide-arrow-prev" onClick={imgCarouselPrev()}>
                  &#8249;
                </button>
                <button className="slide-arrow" id="slide-arrow-next" onClick={imgCarouselNext()}>
                  &#8250;
                </button>
                <ul className="slides-container" id="slides-container">
                  <li className="slide"><img src="../files/ISAAC/index.png" alt="index page" /></li>
                  <li className="slide"><img src="../files/ISAAC/search.png" alt="search page" /></li>
                  <li className="slide"><img src="../files/ISAAC/page.png" alt="page content" /></li>
                  <li className="slide"><img src="../files/ISAAC/analytics.png" alt="page analytics" /></li>
                </ul>
              </section>
            </div>
            <div className='ISAAC_section'>
              <h2 className='ISAAC_section_title'>Project Vision</h2>
              <p className='ISAAC_vision'>With our MVP complete, we hope to started the second half of our project off with another round of user testing. Some features we are looking to improve are the search algorithm as well as the data gathering, aggregation, and serving. Eventually, we would like to reintegrate university authentication to help with assigning administrative privileges and gathering student data that the university already collects.</p>
            </div>
          </section>
...
function imgCarouselNext(): MouseEventHandler {
  const slidesContainer = document.getElementById("slides-container");
  const slide = document.querySelector(".slide");
...
function imgCarouselPrev(): MouseEventHandler {
  const slidesContainer = document.getElementById("slides-container");
  const slide = document.querySelector(".slide");
